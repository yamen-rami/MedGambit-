<x-quizlayout>
    <div>
        ...
        @endpush
        <div
            style="z-index: 1000; position: absolute; top: 10%; right: 50%; color: var(--text)"
            class="rounded-2 my-2 px-5 py-2"
            id="textHasCopied"
        >
            ...
            <div class="grid">
                <div class="card main">
                    <div class="players-grid my-5">
                        ...
                        <div class="vs-text skeleton text-center">
                            <span class="rounded-circle skeleton p-3 text-center text-white">Vs</span>
                        </div>
                        <div class="player-card-skeleton">
                            <div class="player-avatar skeleton"></div>
                ...
                <div class="side">
                    ...
                    <div class="card side-card">
                        ...
                        <div id="challenge_token" class="skeleton my-2 px-3 py-2" style="color: var(--text)">
                            <span
                                class="d-block text-end"
                                id="copyBtn"
                                style="color: var(--text); background-color: transparent"
                            >
                                <svg
                            ...
                            ></span>
                            <span> medgambit.test/friend/challenge/ </span>
                            <span> {{ $game->challenge_token }} </span>
                        </div>
                    </div>
