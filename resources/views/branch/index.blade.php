<x-app>
    ...
    <div class="card">
        <div style="overflow-x: hidden" class="card-datatable table-responsive pt-0">
            <div class="d-grid">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <form class="form" action="{{ route("branch.index") }}">
                            <div class="d-flex gap-3">
                                ...
                                <button class="btn btn-danger">
                                    <a class="text-white" href="{{ route("branch.index") }}">Clear</a>
                                </button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-4 text-center">
                        <a href="{{ route("branch.create") }}">
                            <button class="btn btn-primary">Create A New Branch</button>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('branch.edit', $branch) }}"
            ...
            <div class="align-item-center py-4 ps-4 pe-4">{{ $branches->appends(request()->query())->links() }}</div>
        </div>
        @if ($branches->count() === 0)
