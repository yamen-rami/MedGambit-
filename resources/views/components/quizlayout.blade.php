                        ...
                        <div class="modal-dialog ">
                            <div class="modal-content question-card ">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5 gauge-label" id="staticBackdropLabel">Are You Sure To Quit Quiz </h1>
                                    <button type="button" class="btn-close gauge-label text-white" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <h1 class="gauge-label fs-6" >Your Answers Will Saved And Your <span class="text-danger">Elo</span> Will Change  </h1>
                                </div>
