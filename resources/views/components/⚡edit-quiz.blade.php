                ...
                <div class="col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @enderror
                            <x-textarea
                                value="{{ $this->quiz->topic }}"
                                wire:model="quizTopic"
                                label="Topic"
                                name="quizTopic"
                            ></x-textarea>
                            <x-forms.input
                                wire:model="questionNumber"
                                value="{{ $this->quiz->questions_number }}"
                            ...
                            <div class="mt-4 mb-4">
                                ...
                                <select class="form-select" wire:model="quizDifficulty" name="quizDifficulty">
                                    ...
                                    <option value="medium" @selected($this->quiz->difficulty === 'medium')>
                                        Medium
                                    </option>
