        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>
                    ...
                    <strong> {{ $this->question?->difficulty }} </strong>
                </p>
                <p>
                    <span>Length : </span>
                    <strong> {{ $this->question?->length }} </strong>
                </p>
                <p>
                    <span>Refernce : </span>
                ...
                <div>
                    @foreach ($this->question->options ?? [] as $option)
                        <div
                            class="px-3 bg-inherit options  py-5 my-2 {{ $this->question->correctAnswer() === $option ? "success option-correct" : 'option' }}"
                            style="width: 90%"
                        >
                            <div class="d-flex align-items-center">
                                <span class="me-5"> {{ $option->name }} </span>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary">
                    <a href="{{ route("questions.show", $this->question?->id ?? 0) }}" class="text-white"
                        >More Details
                    </a>
                </button>
            </div>
