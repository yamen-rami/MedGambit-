                    ...
                    @can("is_admin")
                        ...
                        <li class="menu-item ">
                            <a href="{{ route('dashboard') }}" class="menu-link">
                                ...
                                <div data-i18n="Page ">Dashboard</div>
                            </a>
                        </li>
                    @endcan
                        ...
                        <li class="menu-item {{ request()->routeIs('gambits') ? 'active' : '' }}">
                            <a href="{{ route('gambits') }}" class="menu-link">
                                <i class="menu-icon icon-base d-flex align-items-center me-2"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bug">
                                        <path d="M12 20v-9" />
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                ...
                                                <i class="icon-base ti tabler-user icon-md me-3"></i><span> My Profile
                                                </span>
                                            </a>
                                        </li>
