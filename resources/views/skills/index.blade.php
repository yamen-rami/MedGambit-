<x-app>
    ...
    <div class="card">
        <div style="overflow-x: hidden" class="card-datatable table-responsive pt-0">
                ...
                <div class="row align-items-center py-4">
                        ...
                        <form class="form" action="{{ route("skills.index") }}">
                            <div class="d-flex gap-3">
                                ...
                                <button class="btn btn-danger">
                                    <a class="text-white" href="{{ route("skills.index") }}">Clear</a>
                                </button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-4 text-center">
                        <a href="{{ route("skills.create") }}">
                            <button class="btn btn-primary">Create A New Skill</button>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('skills.edit', $skill) }}"
            ...
            <div class="align-item-center py-4 ps-4 pe-4">{{ $skills->appends(request()->query())->links() }}</div>
        </div>
        @if ($skills->count() === 0)
