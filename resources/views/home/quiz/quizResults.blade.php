      ...
      <div class=" my-5 ps-5  ">
        ...
        @foreach($answers as $answer)
          ...
          @foreach($answer->question->options as $option)
            ...
            @endphp
            <div class="d-flex justify-content-between gap-2 align-items-center border
              ...
              <div>
                ...
                <p class="text-primary mb-0 cursor-pointer" data-bs-toggle="modal"
                  data-bs-target="#exampleModal{{ $loop->iteration }}" data-bs-whatever="@getbootstrap">See Explanation</p>

                <div class="modal fade modal-lg" id="exampleModal{{ $loop->iteration }}" tabindex="-1"
